...
public class MainBaca extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_baca);
        db = new MyDatabaseTalent(this);
        adapter_off = new CustomListAdapterTalent(this, ListTalent );
        mListView = (ListView) findViewById(R.id.list_baca);
        ...
        for (Talent cn : contacts) {
            ...
            if ((ListTalent.isEmpty()))
                Toast.makeText(MainBaca.this, "Tidak ada data",
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        Intent goUpdel = new Intent(MainBaca.this, MainDetail.class);
